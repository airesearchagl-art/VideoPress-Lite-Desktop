...
- 画面右下に現在のアプリバージョンを表示
- package.json の version を自動取得
- ヘルプメニューにバージョン情報ダイアログを追加
- VideoPress Lite 用の独自 VP アイコンを追加
- Windowsインストーラー、アプリ、タスクバーへ独自アイコンを適用

## v1.3.0

- 自動アップデート対応
- GitHub Releasesから更新取得
- 手動アップデート確認
- 更新進捗表示
